...
类似，对于 $y=f(x,y)$ ，则有 $F(x,y,z(x,y))\equiv 0$ ，即 $\displaystyle F_x+F_z \frac{\partial z}{\partial x}=0$ ，且 $\displaystyle F_y+F_z\frac{\partial z}{\partial y}=0$ ，即有 $\displaystyle z_x=-\frac{F_x}{F_z}$ ，$\displaystyle z_y=-\frac{F_y}{F_z}$ 。  
